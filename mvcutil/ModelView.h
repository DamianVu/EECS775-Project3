...
protected:
	...
	// Method "getMatrices" does the preceding and more, but is intended
	// strictly for 3D scenes:
	...
	// compute2DScaleTrans (2D) or getMatrices (3D).
	...
	// For storing dynamic rotation and pan:
	static cryph::Matrix4x4 dynamic_view;
};
